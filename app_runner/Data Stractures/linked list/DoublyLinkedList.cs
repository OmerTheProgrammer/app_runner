public class DoublyLinkedList_Node<T>
{
    public T data { get; set; }
    public DoublyLinkedList_Node<T> next { get; set; }
    public DoublyLinkedList_Node<T> previous { get; set; }

    //כדי לא ליצור לולאה אינ-סופית
    public DoublyLinkedList_Node(T value){
        this.data = value;
        this.next = null;
        this.previous = null;
    }
...
{
    public DoublyLinkedList_Node<T> head { get; set; }
    public DoublyLinkedList_Node<T> tail { get; set; }

    public void append(T data){
        DoublyLinkedList_Node<T> to_add = new DoublyLinkedList_Node<T>(data);
        if (this.head == null){
            this.head = to_add;
            this.tail = to_add;
            return;
    ...
    public void add_beginning(T data){
        if (this.head == null){
            this.head = new DoublyLinkedList_Node<T>(data);
            this.tail = new DoublyLinkedList_Node<T>(data);
            return;
        }
        DoublyLinkedList_Node<T> old_head = this.head;
        this.head = new DoublyLinkedList_Node<T>(data);
    ...
    public void remove(T data){
        ...
        DoublyLinkedList_Node<T> current = this.head;
    ...
    public DoublyLinkedList<T> only_even()
    {
        DoublyLinkedList<T> even_list = new DoublyLinkedList<T>();
    ...
    public DoublyLinkedList<T> marge(DoublyLinkedList<T> l2){
        if (this.head == null && l2.head == null){return new DoublyLinkedList<T>();}
    ...
    public DoublyLinkedList<T> revarse(){
        DoublyLinkedList<T> revarsed_list = new DoublyLinkedList<T>();
...
class DoublyLinkedList_presenter
{
    public static void presenter(){
        ...
        DoublyLinkedList<int> l3 = l.marge(l2);
